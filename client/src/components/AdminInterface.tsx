...
<<<<<<< HEAD
  if (uploadForm.lotSizeMin.trim()) formData.append("lotSizeMin", uploadForm.lotSizeMin.trim());
  if (uploadForm.lotSizeMax.trim()) formData.append("lotSizeMax", uploadForm.lotSizeMax.trim());
                      ...
                      <div className="relative">
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            if (e.target.value === '' || (!isNaN(value) && value >= 0 && value <= 35)) {
                              setUploadForm(prev => ({
                                ...prev,
                                roofPitch: e.target.value === '' ? 0 : value
                              }));
                            }
                          }}
                          placeholder="0"
...
<<<<<<< HEAD
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        max="1000"
                        step="0.01"
                        value={uploadForm.totalBuildingHeight}
                        onChange={(e) => {
                          const value = e.target.value;
                          if (value === '') {
                            setUploadForm(prev => ({ ...prev, totalBuildingHeight: 0 }));
