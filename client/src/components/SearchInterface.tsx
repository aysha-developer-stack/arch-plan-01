              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectItem value="Cowra Council">Cowra Council</SelectItem>
                    ...
                    <SelectItem value="Greater Hume Council">Greater Hume Council</SelectItem>
                    ...
                    <SelectItem value="Nambucca Shire Council">Nambucca Shire Council</SelectItem>
                    ...
                    {/* Victoria (VIC) Councils */}
                    <SelectItem value="VIC_HEADER" disabled className="font-extrabold text-slate-900 pointer-events-none bg-slate-50">Victoria (VIC)</SelectItem>
                    ...
                    <SelectItem value="Cutler Bay, Shire of">Cutler Bay, Shire of</SelectItem>
                    ...
                    <SelectItem value="Cedar Park District Council">Cedar Park District Council</SelectItem>
                    ...
                    <SelectItem value="Copper Coast Council">Copper Coast Council</SelectItem>
                    ...
                    <SelectItem value="Mallala District Council">Mallala District Council</SelectItem>
